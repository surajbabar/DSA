...
int main(){
	...
	tearDown();
	testEnded();
	testStarted("test_delete_node_with_int_data_at_end_of_linked_list");
	setup();
		test_delete_node_with_int_data_at_end_of_linked_list();
	tearDown();
	testEnded();
	testStarted("test_delete_node_with_float_data_at_end_of_linked_list");
	setup();
		test_delete_node_with_float_data_at_end_of_linked_list();
	tearDown();
	testEnded();
