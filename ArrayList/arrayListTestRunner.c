...
int main(){
	...
	tearDown();
	testEnded();
	testStarted("test_add_will_insert_element_at_the_end");
	setup();
		test_add_will_insert_element_at_the_end();
	tearDown();
	testEnded();
	testStarted("test_remove_will_remove_element_from_specified_index");
	setup();
		test_remove_will_remove_element_from_specified_index();
	tearDown();
	testEnded();
	testStarted("test_search_will_search_element_from_list");
	setup();
		test_search_will_search_element_from_list();
	tearDown();
	testEnded();
